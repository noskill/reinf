...
python3 wm_train.py --data data.txt \
    ...
    --batch-size 40 --epochs 300 --lr 2e-4 --weight-decay 0.02 \
    --attention-dropout 0.10 --context-len 5 \
    ...
    --save-path outputs/wm_transformer_next_ctx5_300e.pt | tee wm_transformer_next_ctx5_300e.log
