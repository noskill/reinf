...
def parse_args():
    ...
    parser.add_argument("--low-warmup-updates", type=int, default=0)
    parser.add_argument("--low-warmup-goal-noise", type=float, default=0.1)
    parser.add_argument("--high-warmup-horizon", type=int, default=5)
    ...
    parser.add_argument("--wm-contrastive-uncertainty-weight", type=float, default=0.05)
...
def main():
    ...
    if args.wm_contrastive_uncertainty_weight < 0:
        raise ValueError("--wm-contrastive-uncertainty-weight must be >= 0")
