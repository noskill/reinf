...
python3 wm_train.py --data data.txt \
    ...
    --prior-rollout-weight 0.5 --prior-rollout-steps 10 --bptt-horizon 0 \
    --save-path outputs/wm_tssm_prior_rollout_steps10_130e.pt | tee wm_tssm_prior_rollout_steps10_130e.log
