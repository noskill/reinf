...
python3 wm_train.py --data data.txt \
    ...
    --rssm-transition residual --rssm-residual-scale 0.01 --rssm-state-norm rmsnorm \
    ...
    --save-path outputs/wm_rssm_residual_rms_next_600e.pt | tee wm_rssm_residual_rms_next_600e.log
